...
function makePointsResource(schemaOptions = {}) {
  ...
  const schemaObj = {
    ...
    bonuses: new SchemaField({
      level: new game.dnd5e.dataModels.fields.FormulaField({
        deterministic: true,
        label: `${baseLabel}BonusLevel`,
      }),
      overall: new game.dnd5e.dataModels.fields.FormulaField({
        deterministic: true,
        label: `${baseLabel}BonusOverall`,
      }),
    }),
  };
  if (schemaOptions.hasTemp)
    schemaObj.temp = new NumberField({
      integer: true,
      initial: 0,
      min: 0,
  ...
  if (schemaOptions.hasTempMax)
    schemaObj.tempmax = new NumberField({
      integer: true,
      initial: 0,
      ...
      force: new SchemaField(
        {
          known: new SchemaField({
            max: new NumberField({
              ...
              min: 0,
              initial: null,
              label: "SW5E.Powercasting.Force.Known.Max.Override",
            }),
          }),
          level: new NumberField({
            ...
            min: 0,
            initial: null,
            label: "SW5E.Powercasting.Force.Level.Override",
          }),
          limit: new NumberField({
            nullable: true,
            min: 0,
            initial: null,
            label: "SW5E.Powercasting.Force.Limit.Override",
          }),
          maxPowerLevel: new NumberField({
            nullable: true,
            min: 0,
            initial: null,
            label: "SW5E.Powercasting.Force.MaxPowerLevel.Override",
          }),
          points: makePointsResource({
            label: "SW5E.Powercasting.Force.Point.Label",
            hasTemp: true,
          }),
          schools: new SchemaField(
            {
              lgt: new SchemaField({
                attr: new StringField({
                  nullable: true,
                  initial: null,
                  label: "SW5E.Powercasting.Force.School.Lgt.Attr.Override",
                }),
                dc: new NumberField({
                  nullable: true,
                  min: 0,
                  initial: null,
                  label: "SW5E.Powercasting.Force.School.Lgt.Dc.Override",
                }),
              }),
              uni: new SchemaField({
                attr: new StringField({
                  nullable: true,
                  initial: null,
                  label: "SW5E.Powercasting.Force.School.Uni.Attr.Override",
                }),
                dc: new NumberField({
                  nullable: true,
                  min: 0,
                  initial: null,
                  label: "SW5E.Powercasting.Force.School.Uni.Dc.Override",
                }),
              }),
              drk: new SchemaField({
                attr: new StringField({
                  nullable: true,
                  initial: null,
                  label: "SW5E.Powercasting.Force.School.Drk.Attr.Override",
                }),
                dc: new NumberField({
                  nullable: true,
                  min: 0,
                  initial: null,
                  label: "SW5E.Powercasting.Force.School.Drk.Dc.Override",
                }),
              }),
            },
      ...
      tech: new SchemaField(
        {
          known: new SchemaField({
            max: new NumberField({
              ...
              min: 0,
              initial: null,
              label: "SW5E.Powercasting.Tech.Known.Max.Override",
            }),
          }),
          level: new NumberField({
            nullable: true,
            min: 0,
            initial: null,
            label: "SW5E.Powercasting.Tech.Level.Override",
          }),
          limit: new NumberField({
            nullable: true,
            min: 0,
            initial: null,
            label: "SW5E.Powercasting.Tech.Limit.Override",
          }),
          maxPowerLevel: new NumberField({
            nullable: true,
            min: 0,
            initial: null,
            label: "SW5E.Powercasting.Tech.MaxPowerLevel.Override",
          }),
          points: makePointsResource({
            label: "SW5E.Powercasting.Tech.Point.Label",
            hasTemp: true,
          }),
          schools: new SchemaField(
            {
              tec: new SchemaField({
                attr: new StringField({
                  nullable: true,
                  initial: null,
                  label: "SW5E.Powercasting.Tech.School.Tec.Attr.Override",
                }),
                dc: new NumberField({
                  nullable: true,
                  min: 0,
                  initial: null,
                  label: "SW5E.Powercasting.Tech.School.Tec.Dc.Override",
                }),
              }),
            },
  ...
  result.superiority = new SchemaField(
    {
      known: new SchemaField({
        max: new NumberField({
          ...
          min: 0,
          initial: null,
          label: "SW5E.Superiority.Known.Max.Override",
        }),
      }),
      ...
      die: new NumberField({
        ...
        min: 0,
        initial: null,
        label: "SW5E.Superiority.Die.Override",
      }),
      types: new SchemaField(
        {
          physical: new SchemaField({
            attr: new StringField({
              nullable: true,
              initial: null,
              label: "SW5E.Superiority.Type.Physical.Attr.Override",
            }),
            dc: new NumberField({
              nullable: true,
              min: 0,
              initial: null,
              label: "SW5E.Superiority.Type.Physical.Dc.Override",
            }),
          }),
          mental: new SchemaField({
            attr: new StringField({
              nullable: true,
              initial: null,
              label: "SW5E.Superiority.Type.Mental.Attr.Override",
            }),
            dc: new NumberField({
              nullable: true,
              min: 0,
              initial: null,
              label: "SW5E.Superiority.Type.Mental.Dc.Override",
            }),
          }),
          general: new SchemaField({
            attr: new StringField({
              nullable: true,
              initial: null,
              label: "SW5E.Superiority.Type.General.Attr.Override",
            }),
            dc: new NumberField({
              nullable: true,
              min: 0,
              initial: null,
              label: "SW5E.Superiority.Type.General.Dc.Override",
            }),
          }),
        },
...
export function patchDataModels() {
  ...
  libWrapper.register(
    "sw5e",
    "dnd5e.dataModels.item.ClassData.defineSchema",
    addProgression,
    "WRAPPER"
  );
  libWrapper.register(
    "sw5e",
    "dnd5e.dataModels.item.SubclassData.defineSchema",
    addProgression,
    "WRAPPER"
  );
  libWrapper.register(
    "sw5e",
    "dnd5e.dataModels.actor.CreatureTemplate.defineSchema",
  ...
  libWrapper.register(
    "sw5e",
    "dnd5e.dataModels.item.ToolData.defineSchema",
    function (wrapped, ...args) {
      const result = wrapped(...args);
  ...
  libWrapper.register(
    "sw5e",
    "dnd5e.dataModels.item.WeaponData.defineSchema",
    function (wrapped, ...args) {
      const result = wrapped(...args);
