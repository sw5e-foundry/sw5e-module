export function patchConfig(config, strict=true) {
	...
	if (strict) config.weaponIds = {
		// Blasters
		affixedrifle: "Compendium.sw5e-module-test.blasters.Item.vE0EUUI7eE6NGZ1I",
		"anti-materielrifle": "Compendium.sw5e-module-test.blasters.Item.LXfN4Frdg9Neip42",
		arccaster: "Compendium.sw5e-module-test.blasters.Item.xGH5V5Dh3Xd8yRZr",
		assaultcannon: "Compendium.sw5e-module-test.blasters.Item.mXu2wQEqg6czu3X1",
		beamrifle: "Compendium.sw5e-module-test.blasters.Item.eU07RkTEbHfAkaCn",
		bkg: "Compendium.sw5e-module-test.blasters.Item.AChZTm3pFdO51aFE",
		blastercannon: "Compendium.sw5e-module-test.blasters.Item.hGHemt3w37BdkARm",
		blastercarbine: "Compendium.sw5e-module-test.blasters.Item.PoGaGtinF97I9fQ0",
		blasterpistol: "Compendium.sw5e-module-test.blasters.Item.rz0YqUmRxFl79W0K",
		blasterrifle: "Compendium.sw5e-module-test.blasters.Item.Nww9kzfPy9D246fg",
		"bo-rifle": "Compendium.sw5e-module-test.blasters.Item.AohJSYDPWfhsAqHM",
		"bolt-thrower": "Compendium.sw5e-module-test.blasters.Item.9VhsUL3z9o62lUsT",
		bowcaster: "Compendium.sw5e-module-test.blasters.Item.nbUdM3rwdWFLeRQr",
		carbinerifle: "Compendium.sw5e-module-test.blasters.Item.SAWonBPE2WqRRJBd",
		chaingun: "Compendium.sw5e-module-test.blasters.Item.cchq3Zp6gDRHCPmJ",
		compoundbow: "Compendium.sw5e-module-test.blasters.Item.45PDLB373AvNUyJT",
		cryocannon: "Compendium.sw5e-module-test.blasters.Item.UXvCoqvuoLnjj73U",
		cryocarbine: "Compendium.sw5e-module-test.blasters.Item.PkRIfISeSwgqXOBf",
		cryopistol: "Compendium.sw5e-module-test.blasters.Item.btSGBSe1oW54ekiK",
		cryorifle: "Compendium.sw5e-module-test.blasters.Item.4Jw4d9459nFSSsUF",
		cyclerrifle: "Compendium.sw5e-module-test.blasters.Item.yaFeefXN5oCNhZns",
		disruptorcarbine: "Compendium.sw5e-module-test.blasters.Item.9ayhGXQJLdIiaTMF",
		disruptorpistol: "Compendium.sw5e-module-test.blasters.Item.7d9jf8kTjKtzIals",
		disruptorrifle: "Compendium.sw5e-module-test.blasters.Item.yOsWMLHMEtzucKDC",
		disruptorsniper: "Compendium.sw5e-module-test.blasters.Item.wQvskhxKbF3itdx8",
		energybow: "Compendium.sw5e-module-test.blasters.Item.lb1KS1SOtmf384Xv",
		energyslingshot: "Compendium.sw5e-module-test.blasters.Item.FZTA1E9Os0RE1p0k",
		flechettecannon: "Compendium.sw5e-module-test.blasters.Item.lzJCdT9fuPVW5S44",
		grenadelauncher: "Compendium.sw5e-module-test.blasters.Item.1PtYUVAzIi5e2x4H",
		handbkg: "Compendium.sw5e-module-test.blasters.Item.dHVGZmcv4QblKIhU",
		handblaster: "Compendium.sw5e-module-test.blasters.Item.6aTkk5EqFsVKECbn",
		handcannon: "Compendium.sw5e-module-test.blasters.Item.jeBtqq1xgKnDpqwC",
		heavyblasterrifle: "Compendium.sw5e-module-test.blasters.Item.lawuC5DlTMgma6P8",
		heavybowcaster: "Compendium.sw5e-module-test.blasters.Item.LyjP5ioaHCa8sSsp",
		heavycarbine: "Compendium.sw5e-module-test.blasters.Item.YK7Nzdui6FW7dNjE",
		heavypistol: "Compendium.sw5e-module-test.blasters.Item.6S2Lb686mrKTQMTp",
		heavyrepeater: "Compendium.sw5e-module-test.blasters.Item.CUGWEv0xw4OMdjsI",
		heavyshotgun: "Compendium.sw5e-module-test.blasters.Item.TSOf2xTMf792t4af",
		heavyslugpistol: "Compendium.sw5e-module-test.blasters.Item.HXyrCz4Kun53F4kK",
		"hold-out": "Compendium.sw5e-module-test.blasters.Item.V7uuRrAqCINlkgFk",
		huntingrifle: "Compendium.sw5e-module-test.blasters.Item.E1qrlNHZ9VtE0lky",
		incineratorcarbine: "Compendium.sw5e-module-test.blasters.Item.BFsQzs9kgBwTWMzJ",
		incineratorpistol: "Compendium.sw5e-module-test.blasters.Item.EY3jaFiEsO9UzEz9",
		incineratorrifle: "Compendium.sw5e-module-test.blasters.Item.66PqJG2lNxMNCg5C",
		incineratorsniper: "Compendium.sw5e-module-test.blasters.Item.l1vS9YRrwQktdgbI",
		ioncannon: "Compendium.sw5e-module-test.blasters.Item.CVeydl4HQi4PsmZn",
		ioncarbine: "Compendium.sw5e-module-test.blasters.Item.FJMwehrWtdagwsqn",
		ionpistol: "Compendium.sw5e-module-test.blasters.Item.4CdI8yfutf7ZggfY",
		ionrifle: "Compendium.sw5e-module-test.blasters.Item.aXCB2Uap09IIAV0p",
		iws: "Compendium.sw5e-module-test.blasters.Item.EmpVpcgRewUPxdJr",
		lightbow: "Compendium.sw5e-module-test.blasters.Item.gIGxUwvW06msv36V",
		lightningcarbine: "Compendium.sw5e-module-test.blasters.Item.Aq421AKVuVHZjFJQ",
		lightningpistol: "Compendium.sw5e-module-test.blasters.Item.tAzbTqCc6S6aeCvc",
		lightningrifle: "Compendium.sw5e-module-test.blasters.Item.es7oacLob9VulqVC",
		lightpistol: "Compendium.sw5e-module-test.blasters.Item.3MuBVRCfB4j2pmm1",
		lightrepeater: "Compendium.sw5e-module-test.blasters.Item.1QTOj0pBYLaV5WkM",
		lightslugpistol: "Compendium.sw5e-module-test.blasters.Item.md4uo61mzq3xBFh0",
		marksmanblaster: "Compendium.sw5e-module-test.blasters.Item.iY4iRHbLcx10OgRQ",
		mortarlauncher: "Compendium.sw5e-module-test.blasters.Item.jWIMqI3Wg3EJZjMv",
		needler: "Compendium.sw5e-module-test.blasters.Item.tzlA3eYfQSOLVlUw",
		nightstingerrifle: "Compendium.sw5e-module-test.blasters.Item.9h8aYCXd9O2aJThy",
		radiationcannon: "Compendium.sw5e-module-test.blasters.Item.njuvd2AMNQuOBiBw",
		radrifle: "Compendium.sw5e-module-test.blasters.Item.i1d3IODE5XVAeLuw",
		railgun: "Compendium.sw5e-module-test.blasters.Item.zuPhwZGH0j2ovgG7",
		repeatingblaster: "Compendium.sw5e-module-test.blasters.Item.owCClcq8Zp0AJrb8",
		revolver: "Compendium.sw5e-module-test.blasters.Item.KGY7W9ckhHlCmTLI",
		rocketlauncher: "Compendium.sw5e-module-test.blasters.Item.pYsmiZ98tXTfdbt0",
		rocketrifle: "Compendium.sw5e-module-test.blasters.Item.q5JrhC2pyO64xhbu",
		rotarycannon: "Compendium.sw5e-module-test.blasters.Item.hiD9yXYbGr9qpEHP",
		scatterblaster: "Compendium.sw5e-module-test.blasters.Item.aEhiMrl8fQ4uE3od",
		scattergun: "Compendium.sw5e-module-test.blasters.Item.Ul4lKHTI2TocCqBm",
		sentrygun: "Compendium.sw5e-module-test.blasters.Item.O2CMHIk0z1iv5rvq",
		shattercannon: "Compendium.sw5e-module-test.blasters.Item.Gf4x0PAKYQ2XUzLY",
		shatterpistol: "Compendium.sw5e-module-test.blasters.Item.yVgru3dfq2S3HzVB",
		shatterrifle: "Compendium.sw5e-module-test.blasters.Item.Ger4Tz2ZQHBsvIdD",
		shortbow: "Compendium.sw5e-module-test.blasters.Item.bwGON0wPMPw4L2QJ",
		shotgun: "Compendium.sw5e-module-test.blasters.Item.twTqep64yEvD27WD",
		shoulderblaster: "Compendium.sw5e-module-test.blasters.Item.toA1uUGRVwWBpPZv",
		shouldercannon: "Compendium.sw5e-module-test.blasters.Item.quQ1kOTjP0Z4DkE7",
		slugpistol: "Compendium.sw5e-module-test.blasters.Item.nFL3lIO5cZyGdi7h",
		slugthrower: "Compendium.sw5e-module-test.blasters.Item.UnQu0tKV6bRU8fcE",
		smartcannon: "Compendium.sw5e-module-test.blasters.Item.9USEx0BC6Cg262jv",
		smartpistol: "Compendium.sw5e-module-test.blasters.Item.aEj30a3gxRAx7u7u",
		sniperrifle: "Compendium.sw5e-module-test.blasters.Item.Q45OrdLhguL9OWNU",
		soniccannon: "Compendium.sw5e-module-test.blasters.Item.KD3gzWdE6oAai4SR",
		soniccarbine: "Compendium.sw5e-module-test.blasters.Item.efeQYIZhTk6GGTv4",
		sonicpistol: "Compendium.sw5e-module-test.blasters.Item.8EKfBUh1sNYcdyxQ",
		sonicrifle: "Compendium.sw5e-module-test.blasters.Item.Iv36Kvf4Twtr0WQf",
		stealthcarbine: "Compendium.sw5e-module-test.blasters.Item.Gq8Xo1CEp8m1HLEa",
		subrepeater: "Compendium.sw5e-module-test.blasters.Item.gPDZk2wbFxPbbZrl",
		switchcannon: "Compendium.sw5e-module-test.blasters.Item.KO4QzzK90ddtTCeP",
		switchcarbine: "Compendium.sw5e-module-test.blasters.Item.OZhhFSXfVaTxlvMy",
		switchpistol: "Compendium.sw5e-module-test.blasters.Item.BF0DbpSuicX8qHhb",
		switchrifle: "Compendium.sw5e-module-test.blasters.Item.TGpxeKGTfalYK5SA",
		switchsniper: "Compendium.sw5e-module-test.blasters.Item.UZqJABEq0NUKU2Uf",
		torpedolauncher: "Compendium.sw5e-module-test.blasters.Item.WUI1B0CvfWXMUABR",
		tranquilizerrifle: "Compendium.sw5e-module-test.blasters.Item.kTknGaMyXROkwRvm",
		vaporprojector: "Compendium.sw5e-module-test.blasters.Item.PhJpjuTtS0E2dR5M",
		wristblaster: "Compendium.sw5e-module-test.blasters.Item.TlrVX9tsQfnzmyo6",
		wristlauncher: "Compendium.sw5e-module-test.blasters.Item.fhQ3oxD0XojwKnVN",
		wristrifle: "Compendium.sw5e-module-test.blasters.Item.4j1MM03ja8KDnRU2",
		// Lightweapons
		bitesaber: "Compendium.sw5e-module-test.lightweapons.Item.R438U6CVFIcKQUj4",
		blightsaber: "Compendium.sw5e-module-test.lightweapons.Item.SnVUeLTVdJyu6FLA",
		brightsaber: "Compendium.sw5e-module-test.lightweapons.Item.izAkWbwSJEmH6NhS",
		broadsaber: "Compendium.sw5e-module-test.lightweapons.Item.58STrK1evawiWDxe",
		bustersaber: "Compendium.sw5e-module-test.lightweapons.Item.NcPqEgYr26QVzPrs",
		chainedlightdagger: "Compendium.sw5e-module-test.lightweapons.Item.LzWg0JRhhyedB9bi",
		claymoresaber: "Compendium.sw5e-module-test.lightweapons.Item.Zy8993dOg0rOsXoS",
		crossguardsaber: "Compendium.sw5e-module-test.lightweapons.Item.TzLXYpz7oWOPvZQR",
		crosssaber: "Compendium.sw5e-module-test.lightweapons.Item.qfg0n9Yz1aZykKcM",
		doublesaber: "Compendium.sw5e-module-test.lightweapons.Item.T3eHzkaSMMpLuBbr",
		doubleshoto: "Compendium.sw5e-module-test.lightweapons.Item.AVDPyImR6l9E2JEi",
		guardshoto: "Compendium.sw5e-module-test.lightweapons.Item.xYrgfBXhWqh7jsU5",
		lightaxe: "Compendium.sw5e-module-test.lightweapons.Item.Ncx7KBa8wBn9KztD",
		lightbaton: "Compendium.sw5e-module-test.lightweapons.Item.l5JZlEuy2sDFmsxT",
		lightblade: "Compendium.sw5e-module-test.lightweapons.Item.QYOc47JL2U2OCFnM",
		lightclub: "Compendium.sw5e-module-test.lightweapons.Item.OJmYglDcsfSbzuyK",
		lightcutlass: "Compendium.sw5e-module-test.lightweapons.Item.f2Gs7BXTGRANoziO",
		lightdagger: "Compendium.sw5e-module-test.lightweapons.Item.Ri7R7WyapR2CDE9S",
		lightfist: "Compendium.sw5e-module-test.lightweapons.Item.I0DFU813iysKiYCj",
		lightfoil: "Compendium.sw5e-module-test.lightweapons.Item.s3PoP2XP6eNKibCh",
		lightglaive: "Compendium.sw5e-module-test.lightweapons.Item.A2LrY6YdgNv4JL74",
		lightkatana: "Compendium.sw5e-module-test.lightweapons.Item.U1nekOEjEnj6zztB",
		lightnodachi: "Compendium.sw5e-module-test.lightweapons.Item.dHlqXZ0f51MsuNO3",
		lightring: "Compendium.sw5e-module-test.lightweapons.Item.T81gCX274rZCwcUF",
		lightsaber: "Compendium.sw5e-module-test.lightweapons.Item.TjTDmB8pIYSLkQvw",
		lightsaberpike: "Compendium.sw5e-module-test.lightweapons.Item.NKFT1tIzfAAZHsHn",
		lightstaff: "Compendium.sw5e-module-test.lightweapons.Item.TIoL50LbonErh2Zx",
		martiallightsaber: "Compendium.sw5e-module-test.lightweapons.Item.ZAvRnvSdsRnz9CGQ",
		phaseknife: "Compendium.sw5e-module-test.lightweapons.Item.ZaubWVQfostRNL56",
		pikesaber: "Compendium.sw5e-module-test.lightweapons.Item.J0CdF65GSK1tlWr2",
		retrosaber: "Compendium.sw5e-module-test.lightweapons.Item.L47ZLQgshik5X5ea",
		saberaxe: "Compendium.sw5e-module-test.lightweapons.Item.gj2EIKC9sEvLvc2E",
		sabergauntlet: "Compendium.sw5e-module-test.lightweapons.Item.QsWyd6ML0hMEavZT",
		sabermace: "Compendium.sw5e-module-test.lightweapons.Item.bfKWgOJsnedKQZMT",
		saberspear: "Compendium.sw5e-module-test.lightweapons.Item.NvHrxWiR8wiUeEhO",
		saberstaff: "Compendium.sw5e-module-test.lightweapons.Item.8VjKAKu1UfvGU3t5",
		saberwhip: "Compendium.sw5e-module-test.lightweapons.Item.gaFajnxdTGFGVOki",
		shotosaber: "Compendium.sw5e-module-test.lightweapons.Item.RjQEzblykRC6Qn8E",
		sicklesaber: "Compendium.sw5e-module-test.lightweapons.Item.gciw8MclS0kQ40S3",
		sithsaber: "Compendium.sw5e-module-test.lightweapons.Item.AoO7yHMOrYlG67fa",
		splitsaber: "Compendium.sw5e-module-test.lightweapons.Item.2bOBHr15ltB32A46",
		splitshoto: "Compendium.sw5e-module-test.lightweapons.Item.1koRC40oNszzz4oz",
		sunsaber: "Compendium.sw5e-module-test.lightweapons.Item.0Mwf5lFw326kCXaP",
		warsaber: "Compendium.sw5e-module-test.lightweapons.Item.aJmL8jD1ZbmurHGe",
		wristsaber: "Compendium.sw5e-module-test.lightweapons.Item.tct3YIDnft6YS1zm",
    	// Vibroweapons
		atlatl: "Compendium.sw5e-module-test.vibroweapons.Item.NWifgokJSFzhq181",
		bolas: "Compendium.sw5e-module-test.vibroweapons.Item.OPGMDrcn02FOCZia",
		cesta: "Compendium.sw5e-module-test.vibroweapons.Item.BfV4LUJHoOrQTu6N",
		chaineddagger: "Compendium.sw5e-module-test.vibroweapons.Item.lj2Ac5TNN17dzqO1",
		chakram: "Compendium.sw5e-module-test.vibroweapons.Item.WNdBiAgjJ2OweaJq",
		diresword: "Compendium.sw5e-module-test.vibroweapons.Item.eJDETh7Y6pktJIMu",
		direvibroblade: "Compendium.sw5e-module-test.vibroweapons.Item.LjcbRzt4OKcqLTh2",
		disguisedblade: "Compendium.sw5e-module-test.vibroweapons.Item.cWm1U2JsCtS4Lc0m",
		disruptorshiv: "Compendium.sw5e-module-test.vibroweapons.Item.sDwWLdC1Vh1UGKx7",
		doubleblade: "Compendium.sw5e-module-test.vibroweapons.Item.4uqEmrg7kYEQwBvH",
		doublesword: "Compendium.sw5e-module-test.vibroweapons.Item.DDq7CFXPPd72xMO1",
		echostaff: "Compendium.sw5e-module-test.vibroweapons.Item.Xam0lDxRXZxC8MDF",
		electrobaton: "Compendium.sw5e-module-test.vibroweapons.Item.2cIp9LguuQCNMK5L",
		electrohammer: "Compendium.sw5e-module-test.vibroweapons.Item.54tx6Akk0zgga9t7",
		electroprod: "Compendium.sw5e-module-test.vibroweapons.Item.fLc9HA5kRIFA1gIM",
		electrostaff: "Compendium.sw5e-module-test.vibroweapons.Item.Jts0lNqKNG1T6SCe",
		electrovoulge: "Compendium.sw5e-module-test.vibroweapons.Item.Mo0wecw4GamnaZ0A",
		electrowhip: "Compendium.sw5e-module-test.vibroweapons.Item.RraZhaFWTJ4WeDUZ",
		hiddenblade: "Compendium.sw5e-module-test.vibroweapons.Item.rlDrDtvyD7t4FT0M",
		hookedvibroblade: "Compendium.sw5e-module-test.vibroweapons.Item.vHRaNC6nKgNxBqTo",
		jaggedvibroblade: "Compendium.sw5e-module-test.vibroweapons.Item.plzIeYrDtjaATwAM",
		mancatcher: "Compendium.sw5e-module-test.vibroweapons.Item.RxdwCbimr7Ui4mQi",
		martialarts: "Compendium.sw5e-module-test.vibroweapons.Item.znScsGBnRkIijapl",
		nervebaton: "Compendium.sw5e-module-test.vibroweapons.Item.7pk36cb2PRiGAB6F",
		net: "Compendium.sw5e-module-test.vibroweapons.Item.wsVMOyR5QaVKjQgb",
		neuronicwhip: "Compendium.sw5e-module-test.vibroweapons.Item.IQCGTo7CwK91sWOz",
		riotbaton: "Compendium.sw5e-module-test.vibroweapons.Item.eF8C7QvmQeWrYspM",
		riotshocker: "Compendium.sw5e-module-test.vibroweapons.Item.d0EHliz063hXRwI7",
		shockwhip: "Compendium.sw5e-module-test.vibroweapons.Item.DpLxR3D4saT1BSFM",
		stungauntlet: "Compendium.sw5e-module-test.vibroweapons.Item.L8gExg0T6yY1AdWK",
		techaxe: "Compendium.sw5e-module-test.vibroweapons.Item.WhLbnsnz8ee4kkpu",
		techblade: "Compendium.sw5e-module-test.vibroweapons.Item.Ds6DLXoNyRIHPGV4",
		techstaff: "Compendium.sw5e-module-test.vibroweapons.Item.THeSyLakA2GQjCDQ",
		unarmedstrike: "Compendium.sw5e-module-test.vibroweapons.Item.FCj6NN8vS19NEb9w",
		vibroaxe: "Compendium.sw5e-module-test.vibroweapons.Item.K65Mon3IlNoCVGel",
		vibrobaton: "Compendium.sw5e-module-test.vibroweapons.Item.QwQDg9M0vER4KU4O",
		vibrobattleaxe: "Compendium.sw5e-module-test.vibroweapons.Item.eWViIziY3WnF8GAm",
		vibroblade: "Compendium.sw5e-module-test.vibroweapons.Item.nPm9GPg97XybQJ1u",
		vibrobuster: "Compendium.sw5e-module-test.vibroweapons.Item.6mAX46oU2wo1O0PZ",
		vibroclaw: "Compendium.sw5e-module-test.vibroweapons.Item.TU8WRrfFZih8adhm",
		vibroclaymore: "Compendium.sw5e-module-test.vibroweapons.Item.cI346Xc9uCBNlDNt",
		vibrocutlass: "Compendium.sw5e-module-test.vibroweapons.Item.vgTCxwCF8xlWBqU2",
		vibrocutter: "Compendium.sw5e-module-test.vibroweapons.Item.XuOFMQCwr7Rn65ys",
		vibrodagger: "Compendium.sw5e-module-test.vibroweapons.Item.V5O5qbragpM9iUs4",
		vibrodart: "Compendium.sw5e-module-test.vibroweapons.Item.VdakW2NjzGq1IU8J",
		vibroflail: "Compendium.sw5e-module-test.vibroweapons.Item.kgASekRYYKo4Z5Wm",
		vibroglaive: "Compendium.sw5e-module-test.vibroweapons.Item.T4hqmxfsDEP8qnG6",
		vibrohammer: "Compendium.sw5e-module-test.vibroweapons.Item.5h8BtmxLWoevRIOv",
		vibrokatana: "Compendium.sw5e-module-test.vibroweapons.Item.8iXtbbR9GVLFmT5L",
		vibroknife: "Compendium.sw5e-module-test.vibroweapons.Item.6phFf5TrAqic0zIG",
		vibroknuckler: "Compendium.sw5e-module-test.vibroweapons.Item.xQzxcdDcFIBtS3Nr",
		vibrolance: "Compendium.sw5e-module-test.vibroweapons.Item.eECvAHTGLjajlQZ5",
		vibromace: "Compendium.sw5e-module-test.vibroweapons.Item.g29wbWGPwmHiKDAY",
		vibronodachi: "Compendium.sw5e-module-test.vibroweapons.Item.C3Ecqi0qi9J4PEwD",
		vibropike: "Compendium.sw5e-module-test.vibroweapons.Item.aeWrrLHykeDJe3wb",
		vibrorapier: "Compendium.sw5e-module-test.vibroweapons.Item.vrm8NuJPsKTTGSRa",
		vibrosabre: "Compendium.sw5e-module-test.vibroweapons.Item.fdRjSKyG3YNhSfTM",
		vibroshield: "Compendium.sw5e-module-test.vibroweapons.Item.CpV5I4T3SwsqyF2S",
		vibrospear: "Compendium.sw5e-module-test.vibroweapons.Item.skYlTL4WV9pcMLRG",
		vibrostaff: "Compendium.sw5e-module-test.vibroweapons.Item.XaWdPLOR9ufOg1lA",
		vibrostiletto: "Compendium.sw5e-module-test.vibroweapons.Item.e3dkWzTi9DLiWkU3",
		vibrosword: "Compendium.sw5e-module-test.vibroweapons.Item.fGmREzOTvQ2CQYHl",
		vibrotonfa: "Compendium.sw5e-module-test.vibroweapons.Item.MQ8dYXV7wIUNsZOi",
		vibrowhip: "Compendium.sw5e-module-test.vibroweapons.Item.RpliZqbwKROc20oP",
		warhat: "Compendium.sw5e-module-test.vibroweapons.Item.R2Mkp4Val8DHfHEv",
		warsword: "Compendium.sw5e-module-test.vibroweapons.Item.VzCZvULJMfoY1f5P",
		wristblade: "Compendium.sw5e-module-test.vibroweapons.Item.p8AoTEx9ySGHmJZu",
	};
	if (strict) config.ammoIds = {
		arrow: "Compendium.sw5e-module-test.ammo.Item.kW97lhvo8rYMypG0",
		arrowcombustive: "Compendium.sw5e-module-test.ammo.Item.n1gjy0mheXViYfsE",
		arrowelectroshock: "Compendium.sw5e-module-test.ammo.Item.q5XpHt4TEi7JY4IM",
		arrownoisemaker: "Compendium.sw5e-module-test.ammo.Item.rWNnt31Qc8vijcUb",
		bolt: "Compendium.sw5e-module-test.ammo.Item.bXgrfvShJWyNygV0",
		boltdeafening: "Compendium.sw5e-module-test.ammo.Item.dmodQxWAT6Bfrhns",
		boltelectrifying: "Compendium.sw5e-module-test.ammo.Item.NNjJbfRx67JdirSR",
		boltpanic: "Compendium.sw5e-module-test.ammo.Item.z7ztMrbJCh3cl5LM",
		corrosivecartridge: "Compendium.sw5e-module-test.ammo.Item.eNEdlWIHLR3yflJM",
		cryocell: "Compendium.sw5e-module-test.ammo.Item.0gGP4fOTbT5Nr0UP",
		dart: "Compendium.sw5e-module-test.ammo.Item.ld3OaEeYKbfHUtUC",
		deafeningcalibrator: "Compendium.sw5e-module-test.ammo.Item.4PPbZh3aWNVgkGEE",
		deafeningcell: "Compendium.sw5e-module-test.ammo.Item.HwoQydBMvGIrHcxI",
		deafeningcollimator: "Compendium.sw5e-module-test.ammo.Item.21IMgkOdo3vPnJlo",
		deafeningdart: "Compendium.sw5e-module-test.ammo.Item.9Fgu4ImgnUh3nALy",
		electrifyingcalibrator: "Compendium.sw5e-module-test.ammo.Item.Ir6H3twcOBgEKEVe",
		electrifyingcartridge: "Compendium.sw5e-module-test.ammo.Item.Ebbb4CPzKhzF1hNk",
		electrifyingcollimator: "Compendium.sw5e-module-test.ammo.Item.CFAPdZKogjI5VDsC",
		electrifyingdart: "Compendium.sw5e-module-test.ammo.Item.PhZJjeGTlaftiIX5",
		flechetteclipfragmentation: "Compendium.sw5e-module-test.ammo.Item.S0hF8VlOBRPiKzJc",
		flechetteclipion: "Compendium.sw5e-module-test.ammo.Item.AhnNsZEaSyt5vQoa",
		flechetteclipplasma: "Compendium.sw5e-module-test.ammo.Item.JhA6Fk0CmRAhWQqs",
		flechettemagfragmentation: "Compendium.sw5e-module-test.ammo.Item.WFGBHjctJW2G8Ous",
		flechettemagion: "Compendium.sw5e-module-test.ammo.Item.mZ0ZWeKLLAPTWzos",
		flechettemagplasma: "Compendium.sw5e-module-test.ammo.Item.YpAiDCFvnJ9DFH0q",
		fluxcollimator: "Compendium.sw5e-module-test.ammo.Item.8pm1jGUlEEcYXXZG",
		gascartridge: "Compendium.sw5e-module-test.ammo.Item.HLuN9PeH3L2SEV01",
		incendiarycell: "Compendium.sw5e-module-test.ammo.Item.aIRzZOPc6kfGQjpQ",
		missilefragmentation: "Compendium.sw5e-module-test.ammo.Item.dP1OJg8DNYwKRbbN",
		missileincendiary: "Compendium.sw5e-module-test.ammo.Item.NtAv7g53vVoHGGbQ",
		missileion: "Compendium.sw5e-module-test.ammo.Item.I8TXYDvGwMmBcYuS",
		oscillationcalibrator: "Compendium.sw5e-module-test.ammo.Item.sPAXclp1H3d1OinS",
		paniccalibrator: "Compendium.sw5e-module-test.ammo.Item.SrUO28T2x6jeNReS",
		paniccollimator: "Compendium.sw5e-module-test.ammo.Item.F89IDxtKvqG9MIbD",
		panicdart: "Compendium.sw5e-module-test.ammo.Item.LlVD11rEsLRXu6M3",
		powercell: "Compendium.sw5e-module-test.ammo.Item.oeJaLYngzLX0x6Yj",
		powergenerator: "Compendium.sw5e-module-test.ammo.Item.yeyBmy7LpYNzP5GN",
		projectorcanistercorrosive: "Compendium.sw5e-module-test.ammo.Item.DTHeXNdbxQNWCSuR",
		projectorcanistercryo: "Compendium.sw5e-module-test.ammo.Item.F6zNyxxWi8TiUb4m",
		projectorcanisterincendiary: "Compendium.sw5e-module-test.ammo.Item.F1uipGbRDApT0sMX",
		projectortankcorrosive: "Compendium.sw5e-module-test.ammo.Item.FFHbfcWjrvgf8ld6",
		projectortankcryo: "Compendium.sw5e-module-test.ammo.Item.A2Dpmn2IDuhwFgS4",
		projectortankincendiary: "Compendium.sw5e-module-test.ammo.Item.YcEOLA1eLtDmlJOI",
		rocketfragmentation: "Compendium.sw5e-module-test.ammo.Item.JcaUDwCQIjqhvHUn",
		rocketincendiary: "Compendium.sw5e-module-test.ammo.Item.0bQtnYFq1LxRqNeJ",
		rocketion: "Compendium.sw5e-module-test.ammo.Item.eRVG9TORFV6YGuA0",
		slugcartridge: "Compendium.sw5e-module-test.ammo.Item.td6veREVMHQB6kiU",
		snare: "Compendium.sw5e-module-test.ammo.Item.pyFkRdUK4sZZrJtG",
		torpedofragmentation: "Compendium.sw5e-module-test.ammo.Item.rkYFnv2yNA9mh8Jk",
		torpedoplasma: "Compendium.sw5e-module-test.ammo.Item.6fDA5yg8WAoCBGlk",
	};
	// Tools
	config.toolTypes.kit = config.toolProficiencies.kit = "SW5E.ToolSpecialistKit";
	if (strict) config.toolIds = {
		// Gaming Sets
		chancecubes: "Compendium.sw5e-module-test.gamingsets.Item.kqt52rtjpaz6jiCf",
		dejarikset: "Compendium.sw5e-module-test.gamingsets.Item.dKho3HXE7XfS4iRU",
		kirgatzset: "Compendium.sw5e-module-test.gamingsets.Item.vKrWBDhbSZDtdiTv",
		pazaakdeck: "Compendium.sw5e-module-test.gamingsets.Item.XfClqzNPbjJxHqil",
		sabaccdeck: "Compendium.sw5e-module-test.gamingsets.Item.RvFP7y8VWPMROQWv",
		// Artisan's Implements
		armormechsimplements: "Compendium.sw5e-module-test.implements.Item.sjsX3NYk7eZ4udlw",
		armstechsimplements: "Compendium.sw5e-module-test.implements.Item.Mrwh3CEneCPnPP1T",
		artificersimplements: "Compendium.sw5e-module-test.implements.Item.w7lWDrGgZeYbwiSH",
		artistsimplements: "Compendium.sw5e-module-test.implements.Item.OXlKtbL29bLUluf2",
		astrotechsimplements: "Compendium.sw5e-module-test.implements.Item.RlQ4zlWA7EdohcEh",
		audiotechsimplements: "Compendium.sw5e-module-test.implements.Item.VNto9t3diElKRHWG",
		biotechsimplements: "Compendium.sw5e-module-test.implements.Item.QTg2sCpSdPfyUoCq",
		constructorsimplements: "Compendium.sw5e-module-test.implements.Item.5HKxptQKBFED544u",
		cybertechsimplements: "Compendium.sw5e-module-test.implements.Item.9w7V1PCf2aD4caVP",
		gadgeteersimplements: "Compendium.sw5e-module-test.implements.Item.GJrYc9KQ22o7qTlz",
		geneticistsimplements: "Compendium.sw5e-module-test.implements.Item.80xuLufR1m7kpNRs",
		jewelersimplements: "Compendium.sw5e-module-test.implements.Item.EYpkyPlywQaH9Ivy",
		surveyorsimplements: "Compendium.sw5e-module-test.implements.Item.SvureMOX5qo6LqGt",
		synthweaversimplements: "Compendium.sw5e-module-test.implements.Item.uP1rZHmbOmg8BUaX",
		tinkersimplements: "Compendium.sw5e-module-test.implements.Item.IkmQFQjGc4xq0Czd",
		writersimplements: "Compendium.sw5e-module-test.implements.Item.tkJEw4ZB5EbFJHPG",
		// Specialist's Kit
		alchemistskit: "Compendium.sw5e-module-test.kits.Item.9DWrsRqwXfHN47Nk",
		archaeologistkit: "Compendium.sw5e-module-test.kits.Item.WrJhpfymps4yRBdk",
		artilleristskit: "Compendium.sw5e-module-test.kits.Item.jJ1CiyKVXOlyjn8h",
		bioanalysiskit: "Compendium.sw5e-module-test.kits.Item.fWoNUuZCNLG8W67s",
		biochemistskit: "Compendium.sw5e-module-test.kits.Item.pq0o4lUKg8Nl08yf",
		brewerskit: "Compendium.sw5e-module-test.kits.Item.OAt131yAvZYPlUmO",
		chefskit: "Compendium.sw5e-module-test.kits.Item.BnhGtUc9G7issUcW",
		demolitionskit: "Compendium.sw5e-module-test.kits.Item.gyhyVW4PEUWLpZTL",
		disguisekit: "Compendium.sw5e-module-test.kits.Item.ChmVrypurts3VY7i",
		forgerykit: "Compendium.sw5e-module-test.kits.Item.ksrKs7yvm7X7CMxA",
		mechanicskit: "Compendium.sw5e-module-test.kits.Item.NubaMVVv3vNwbtuj",
		munitionskit: "Compendium.sw5e-module-test.kits.Item.VJL0ue7Bpl3s0MHx",
		poisonerskit: "Compendium.sw5e-module-test.kits.Item.ofea5VziX4jBg5So",
		scavengingkit: "Compendium.sw5e-module-test.kits.Item.NVxy5wBSpJcHxPEm",
		securitykit: "Compendium.sw5e-module-test.kits.Item.nqf9reJDGplVaeac",
		slicerskit: "Compendium.sw5e-module-test.kits.Item.Yonb0zHFV9asPJHq",
		spicerskit: "Compendium.sw5e-module-test.kits.Item.NlppEcEGpDVDyPiH",
		trapperskit: "Compendium.sw5e-module-test.kits.Item.cIfzetKEwhczahBr",
		// Musical Instruments
		bandfill: "Compendium.sw5e-module-test.musicalinstruments.Item.ic6PBK7VxBLk24rZ",
		chindinkaluhorn: "Compendium.sw5e-module-test.musicalinstruments.Item.NgKMduBdltQQqgnC",
		drum: "Compendium.sw5e-module-test.musicalinstruments.Item.sryr7sQ5IeUny6cd",
		fanfar: "Compendium.sw5e-module-test.musicalinstruments.Item.wASdyFsdQEJHhXeC",
		fizzz: "Compendium.sw5e-module-test.musicalinstruments.Item.IZEi9N6YzWFBHpNh",
		flute: "Compendium.sw5e-module-test.musicalinstruments.Item.mumHDhvGww117xoq",
		kloohorn: "Compendium.sw5e-module-test.musicalinstruments.Item.PfxeK6e5htdyzDEP",
		lute: "Compendium.sw5e-module-test.musicalinstruments.Item.BE1Tg7LCM7yfwypT",
		mandoviol: "Compendium.sw5e-module-test.musicalinstruments.Item.9hYtv8pguNI8aae9",
		ommnibox: "Compendium.sw5e-module-test.musicalinstruments.Item.e9nNVlBmPvPD6cbU",
		shawm: "Compendium.sw5e-module-test.musicalinstruments.Item.BLDVxPfj8jQw1DUN",
		slitherhorn: "Compendium.sw5e-module-test.musicalinstruments.Item.WZbBxDVRLynROWbf",
		traz: "Compendium.sw5e-module-test.musicalinstruments.Item.XwLhLqUJMahD3fo6",
		valahorn: "Compendium.sw5e-module-test.musicalinstruments.Item.sNnvwOZrUp5xJuHe",
		xantha: "Compendium.sw5e-module-test.musicalinstruments.Item.WVSGXxzBoTUoPvi9",
	};
	// Ability Consumption
	...
	if (strict) config.armorIds = {
		combatsuit: "Compendium.sw5e-module-test.armor.Item.iJXWiOLOQcVohJBN",
		fiberarmor: "Compendium.sw5e-module-test.armor.Item.zAkvWO8lEohqewbB",

		compositearmor: "Compendium.sw5e-module-test.armor.Item.mToMe4McIkZRIeCN",
		mesharmor: "Compendium.sw5e-module-test.armor.Item.WalIq3DWny0Ud4Vn",
		weavearmor: "Compendium.sw5e-module-test.armor.Item.hpN14Vhgw82PHeEz",

		assaultarmor: "Compendium.sw5e-module-test.armor.Item.GO4yvhWLgLTrU0xb",
		battlearmor: "Compendium.sw5e-module-test.armor.Item.wafF3SF4zQBOs34y",
		heavyexoskeleton: "Compendium.sw5e-module-test.armor.Item.ggFMzbQrwkGZCoaQ",
	};
	if (strict) config.shieldIds = {
		lightphysicalshield: "Compendium.sw5e-module-test.armor.Item.k1pOOCzZoWEr5Dia",
		lightshieldgenerator: "Compendium.sw5e-module-test.armor.Item.eMXpw3HIVMnaNFQ1",

		mediumphysicalshield: "Compendium.sw5e-module-test.armor.Item.4vGeVWgLIUfN9YiB",
		mediumshieldgenerator: "Compendium.sw5e-module-test.armor.Item.R2GRWrNHmAZzksg5",

		heavyphysicalshield: "Compendium.sw5e-module-test.armor.Item.KvzKRKNWATwdzxjz",
		heavyshieldgenerator: "Compendium.sw5e-module-test.armor.Item.2u9493AUhrh2AfES",
	};
	...
	if (strict) config.containerTypes = {
		backpack: "Compendium.sw5e-module-test.adventuringgear.Item.PN7A13FrDSyo2Neg",
		bottle: "Compendium.sw5e-module-test.adventuringgear.Item.WmT9R9tLTJ9yRTfP",
		bucket: "Compendium.sw5e-module-test.adventuringgear.Item.b3D7Wid3bik2Xlst",
		camtono: "Compendium.sw5e-module-test.adventuringgear.Item.XuAbKi14AZTKnouv",
		canteen: "Compendium.sw5e-module-test.adventuringgear.Item.diDeGGcu9chi0Sys",
		chest: "Compendium.sw5e-module-test.adventuringgear.Item.MjUTZY5SnDWCaX0o",
		crate: "Compendium.sw5e-module-test.adventuringgear.Item.Y3cPZev6cVmfYpDz",
		flask: "Compendium.sw5e-module-test.adventuringgear.Item.3IZ4M5tgF6sVeleY",
		hovercart: "Compendium.sw5e-module-test.adventuringgear.Item.NV7w8EsXcNOjGfdy",
		jug: "Compendium.sw5e-module-test.adventuringgear.Item.9ssHBQvPFrSeB9nu",
		pitcher: "Compendium.sw5e-module-test.adventuringgear.Item.tNDMj0ofQupjYbUP",
		pot: "Compendium.sw5e-module-test.adventuringgear.Item.V6HwYvTHkJiubxJS",
		pouch: "Compendium.sw5e-module-test.adventuringgear.Item.3hZYvPRii0zqaOdh",
		sack: "Compendium.sw5e-module-test.adventuringgear.Item.7ahkqGMiHMWRFtg3",
		smugglepack: "Compendium.sw5e-module-test.adventuringgear.Item.xxl1lBqJaegzesdU",
		tankard: "Compendium.sw5e-module-test.adventuringgear.Item.9hOQLERdixohVRLB",
		vial: "Compendium.sw5e-module-test.adventuringgear.Item.VONgs3pCXP5fPWYc",
	};
	...
	config.focusTypes = {
		...
		force: {
			...
			itemIds: {
				focusgenerator: "Compendium.sw5e-module-test.adventuringgear.Item.mcGJhS8B2IJgomSB",
			}
		},
		tech: {
			label: "SW5E.Focus.Tech",
			itemIds: {
				wristpad: "Compendium.sw5e-module-test.adventuringgear.Item.1t8Bxbq4vlbkAUzo",
			}
		}
	}
	// Features
