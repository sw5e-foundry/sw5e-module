...
export function addHooks() {
  ...
  // ActorData Hooks
  addHook(
    "dnd5e.dataModels.ActorDataModel.prototype._prepareScaleValues",
    "ActorDataModel._prepareScaleValues"
  );
  // SpellData Hooks
  addHookAsync("dnd5e.dataModels.item.SpellData.prototype.getSheetData", "SpellData.getSheetData");
  addHook(
    "dnd5e.dataModels.item.SpellData.prototype.availableAbilities",
    "SpellData.availableAbilities"
  );
  ...
  // ActorSheet5e Hooks
  addHook(
    "dnd5e.applications.actor.ActorSheet5e.prototype._onDropSpell",
    "ActorSheet5e._onDropSpell"
  );
  addHook(
    "dnd5e.applications.actor.ActorSheet5e.prototype._prepareSpellbook",
    "ActorSheet5e._prepareSpellbook"
  );
  addHookAsync(
    "dnd5e.applications.actor.ActorSheet5e.prototype.getData",
    "ActorSheet5eCharacter.getData"
  );
  // ItemSheet5e Hooks
  // ?
  // ActivityUsageDialog Hooks
  addHookAsync(
    "dnd5e.applications.activity.ActivityUsageDialog.prototype._prepareScalingContext",
    "ActivityUsageDialog._prepareScalingContext"
  );
  addHookAsync(
    "dnd5e.applications.activity.ActivityUsageDialog.prototype._prepareSubmitData",
    "ActivityUsageDialog._prepareSubmitData"
  );
}
