...
- New compendium layout leaves some empty folders which may need to be manually removed after updating. I have not figured out how to delete those automatically.
